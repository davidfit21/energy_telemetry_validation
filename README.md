...
Note: Large raw and intermediate/final Parquet datasets are not stored in this GitHub repository.
...
processing/parquet_validated/
```
The Hugging Face validated dataset Version 1 is found here:
https://huggingface.co/datasets/David-Fit/Data_Centre_Electrical_Telemetry
...
The detailed numerical results of the validation process will be documented in the accompanying validation outputs and incorporated into a formal academic paper describing the engineering validation framework, methodology, results, and findings.
